...
SWIFT_MODULE_NAMESPACE_PUSH("pro2_wifi")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC9pro2_wifi11AppDelegate")
...
SWIFT_CLASS("_TtC9pro2_wifi5Audio")
@interface Audio : NSObject <MPMediaPickerControllerDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
